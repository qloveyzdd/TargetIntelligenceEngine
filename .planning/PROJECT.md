...
- **开源形态**: 项目按开源仓库维护，说明文档、规划文件和关键设计决策需要适合公开协作
- **规划公开**: `.planning/` 作为公开项目资产纳入版本控制，而不是仅作本地私有规划
- **上传节奏**: 初始化完成、每个 phase 完成、每个 milestone 完成后都需要推送到远端仓库
...
| `.planning/` 与项目规划过程公开 | 开源项目需要让决策链和路线图可见、可协作、可追踪 | - Pending |
